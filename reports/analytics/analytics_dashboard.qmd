...
end_date <- as.Date(
  if (is.null(params$end_date)) today_local else params$end_date
)
```
...
if (!file.exists(cache_file)) {
  ...
  assessment_card <- dbGetQuery(
    conn,
    "SELECT * FROM pinval.assessment_card"
  )
...
# Remove today from cached dates if refresh_today is not FALSE
if (refresh_today != FALSE) {
