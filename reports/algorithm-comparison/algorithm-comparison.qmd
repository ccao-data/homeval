...
plot_ind_obs <- function(df, x, y, grp, x_lab, y_lab, grp_lab) {
  ...
  purrr::map(
    stats::setNames(desc_vals, desc_vals),
    function(desc_val) {

      df_desc <- df %>% dplyr::filter(description == desc_val)
        ...
        geom_point(
          aes(
            ...
            text = paste0(
              ...
              "Avg. Comp. Price: ",
              scales::dollar(wt_avg_comp_sale_price, accuracy = 1), "<br>",
              "Avg. Comp. Score: ",
        ...
        geom_point(
          aes(
            ...
            text = paste0(
              ...
              "Wt. Avg. Comp. Bldg. S.F.: ",
              round(wt_avg_comp_char_bldg_sf, 2), "<br>",
              "Target Land S.F.: ", target_char_land_sf, "<br>",
              "Wt. Avg. Comp. Land S.F.: ",
              round(wt_avg_comp_char_land_sf, 2), "<br>",
              "Target Beds: ", target_char_beds, "<br>",
              "Wt. Avg. Comp. Beds: ",
              round(wt_avg_comp_char_beds, 2), "<br>",
              "Target Full Baths: ", target_char_fbath, "<br>",
              "Wt. Avg. Comp. Full Baths: ",
              round(wt_avg_comp_char_fbath, 2), "<br>",
              "Target Half Baths: ", target_char_hbath, "<br>",
              "Wt. Avg. Comp. Half Baths: ",
              round(wt_avg_comp_char_hbath, 2), "<br>",
              "Avg. Comp. Score: ",
              scales::percent(avg_comp_score, accuracy = 1)
            )
          )
...
comps_by_pin_sales_agg <- merged_no_flags[
  ...
  description = data.table::first(description)
  ),
...
### Indiv. Char. Obs. By Run

```{r}
data <- plot_ind_obs(
  df      = comps_by_pin_sales_agg_sample,
  x       = "pred_pin_final_fmv",
  y       = "target_sale_price",
  grp     = "target_township_name",
  x_lab   = "Estimated FMV",
  y_lab   = "Sale Price",
  grp_lab = "Township"
)
