...
comps_by_pin_sales_agg <- merged_no_flags[
  ...
  , .(
    ...
    avg_comp_char_beds   = mean(comp_char_beds, na.rm = TRUE),

    target_char_fbath    = data.table::first(target_char_fbath),
    avg_comp_char_fbath  = mean(comp_char_fbath, na.rm = TRUE),

    target_char_hbath    = data.table::first(target_char_hbath),
    avg_comp_char_hbath  = mean(comp_char_hbath, na.rm = TRUE),
