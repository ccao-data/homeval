    ...
    geom_point(
      aes(
        ...
        text = paste0(
          ...
          "Wt. Avg. Comp. Dist. (ft.): ",
          round(wt_avg_comp_dist_ft, 2), "<br>",
          "Target Yrblt.: ",
          target_char_yrblt, "<br>",
          "Wt. Avg. Comp. Yrblt.: ",
          round(wt_avg_comp_char_yrblt, 2), "<br>",
          "Target Bldg. S.F.: ",
          target_char_bldg_sf, "<br>",
          "Wt. Avg. Comp. Bldg. S.F.: ",
          round(wt_avg_comp_char_bldg_sf, 2), "<br>",
          "Target Land S.F.: ",
          target_char_land_sf, "<br>",
